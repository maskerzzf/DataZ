...
public class DateColumn extends Column {
    ...
    public String asString() {
        switch (this.subType) {
            case DATE:
                return new SimpleDateFormat(dateFormat).format(this.asString());
            case DATETIME:
                return new SimpleDateFormat(datetimeFormat).format(this.asString());
            case TIME:
                return new SimpleDateFormat(timeFormat).format(this.asString());
        }
        return null;
    }
